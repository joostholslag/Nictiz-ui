        ...
        <div class="card">
          ...
          <div class="card-body">
            <p class="muted" style="margin-top:0">
              Probes EHRbase's <span class="mono">/admin</span> API with the BFF's own
              credentials, using the one read-only admin route
              (<span class="mono">GET /admin/status</span>) so the check itself can never
              change anything. <strong>Blocked</strong> is the secure default this stack
              expects; <strong>granted</strong> means this service account currently holds
              admin rights over the CDR.
            </p>
            ${this.adminCheck
